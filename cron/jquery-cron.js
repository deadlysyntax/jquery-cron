    ...
    var methods = {
        init : function(opts) {
            ...
            block["period"] = $("<span class='cron-period'>"
                    + "Every <select name='"+namespaceWrap( o, 'cron-period' )+"'>" + custom_periods
            ...
            block["dom"] = $("<span class='cron-block cron-block-dom'>"
                    + " on the <select name='"+namespaceWrap( o, 'cron-dom' )+"'>" + str_opt_dom
                    + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["month"] = $("<span class='cron-block cron-block-month'>"
                    + " of <select name='"+namespaceWrap( o, 'cron-month' )+"'>" + str_opt_month
                    + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["mins"] = $("<span class='cron-block cron-block-mins'>"
                    + " at <select name='"+namespaceWrap( o, 'cron-mins' )+"'>" + str_opt_mih
            ...
            block["dow"] = $("<span class='cron-block cron-block-dow'>"
                    + " on <select name='"+namespaceWrap( o, 'cron-dow' )+"'>" + str_opt_dow
                    + "</select> </span>")
                .appendTo(this)
                .data("root", this);
            ...
            block["time"] = $("<span class='cron-block cron-block-time'>"
                    + " at <select name='"+namespaceWrap( o, 'cron-time-hour' )+"' class='cron-time-hour'>" + str_opt_hid
                    + "</select>:<select name='"+namespaceWrap( o, 'cron-time-min' )+"' class='cron-time-min'>" + str_opt_mih
                    + " </span>")
                .appendTo(this)
                .data("root", this);
